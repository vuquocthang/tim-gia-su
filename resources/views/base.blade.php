...
<head>
    ...
    <title>Gia Sư Smart - Tuyển Gia Sư Chất Lượng</title>
...
* Copyright 2014 jQuery Foundation and other contributors; Licensed MIT */
    ...
    <!--[if lt IE 9]>
    <script type="text/javascript" src="../fvcontentsone.blob.core.windows.net/freelancerviettemplates/materials/js/libs/utils/html5shiv.js"></script>
    <script type="text/javascript" src="../fvcontentsone.blob.core.windows.net/freelancerviettemplates/materials/js/libs/utils/respond.min.js"></script>
    <![endif]-->


    <script type="text/javascript" src="../fvcontentsone.blob.core.windows.net/freelancerviettemplates/materials/js/plugins.min.js-v10.htm"></script>
    ...
    <link type="text/css" rel="stylesheet" href="../fvcontentsone.blob.core.windows.net/freelancerviettemplates/materials/css/theme-default/libs/select2/select2.css" />
    <link type="text/css" rel="stylesheet" href="../fvcontentsone.blob.core.windows.net/freelancerviettemplates/materials/js/flexslider/flexslider.css" />
    <script type="text/javascript" src="../fvcontentsone.blob.core.windows.net/freelancerviettemplates/materials/js/libs/jquery-validation/dist/jquery.validate.min.js"></script>
    <script type="text/javascript" src="../fvcontentsone.blob.core.windows.net/freelancerviettemplates/materials/js/libs/jquery-validation/dist/additional-methods.min.js"></script>
    <script type="text/javascript" src="../fvcontentsone.blob.core.windows.net/freelancerviettemplates/materials/js/libs/select2/select2.min.js"></script>
    ...
    <script type="text/javascript">
        function viewmore(_this) {
            var parent = $(_this).parent(),
                content = parent.attr("data-content");
            parent.addClass("scroll-default-right").html(content);
        }
        ...
        (function() {
            ...
            $window.load(function() {
                flexslider = $('.flexslider-testimonial').flexslider({
                    animationLoop: true,
                    smoothHeight: true,
                    slideshow: false,
                    animation: "slide",
    ...
    <script type="application/ld+json">{"@context":"http:\/\/schema.org","@type":"Organization","name":"freelancerViet - Tuy\u1ec3n \u0110\u00daNG freelancer trong v\u00f2ng 24 gi\u1edd","url":"https:\/\/freelancerviet.vn","logo":"https:\/\/freelancerviet.vn\/templates\/materials\/images\/logo.png","address":{"@type":"PostalAddress","streetAddress":"359A Hu\u1ef3nh T\u1ea5n Ph\u00e1t, Ph\u01b0\u1eddng T\u00e2n Thu\u1eadn \u0110\u00f4ng","addressLocality":"Qu\u1eadn 7","addressRegion":"TP. H\u1ed3 Ch\u00ed Minh","addressCountry":"Vi\u1ec7t Nam"},"contactPoint":{"@type":"ContactPoint","telephone":"+84 28 3932 6966","contactType":"Customer Service","areaServed":"VN","availableLanguage":["English","Vietnamese"]},"sameAs":["https:\/\/www.facebook.com\/FreelancerViet","https:\/\/twitter.com\/freelancerViet","https:\/\/plus.google.com\/u\/5\/+freelancervietvncongdong"]}</script>
</head>
            ...
            <div class="headerbar-menu ">
                            ...
                            <div class="brand-holder">
                                <a href="index.htm">
                                        <span class="text-lg text-bold text-primary">
										                      <img alt="" src="my-custom/logo-v2.png" />
										                    </span>
                                </a>
                            </div>
                        </li>
                ...
                <div class="headerbar-main ">
                    <div id="mainmenu">
                        ...
                        <ul class="mainmenu">
                            <li>
                                <a href="cong-viec-freelance.html" class="">
                                    <span class="title">Tìm lớp</span>
                                </a>
                            </li>
                            <li>
                ...
                <div class="headerbar-right">
                    ...
                    <ul class="header-nav header-nav-options">
                        ...
                        <li class="btn-cta">
                                <span>
									<a class="btn btn-primary btn-raised" href="dang-viec.html" rel="nofollow">Đăng lớp</a>
								</span>
                        </li>
                    </ul>
                            ...
                            <div class="dropdown-menu width-7">
                                <div class="col-md-12">
                                    <form method="post" action="index.htm" class="form login-form login-form-ajax">
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control email" placeholder="Địa chỉ email">
                                        </div>
                                        <div class="form-group">
...
<div id="base">
    ...
    <div id="content">
        <section class="full-page">
            <div class="section-body contain-lg full-page">
                <div class="site-banner">
                        <span class="slider-text-wrap">
		<span class="slider-text1">Giải quyết tức thì mọi nhu cầu tìm gia sư của bạn bởi các<br /><strong>gia sư tốt nhất</strong></span>
                        <span class="slider-text2">Bất kỳ môn học nào – Bất kể nơi đâu</span>
                        <p class="text-center">
                            <a href="cach-tuyen-freelancer.html" class="text-white">Tìm hiểu thêm</a>
                        </p>
                        <div class="text-center mar-30-top btn-postjob-desktop">
                            <form id="form-postjob" action="index.htm" method="POST">
                                <div class="form-group bg-white mar-cennter">
                                    <div class="input-group">
                                        <div class="input-group-content">
                                            <select name="category_id" class="form-control select2-list " placeholder="Bạn cần thuê gia sư dạy môn nào?">
                                                <option></option>

                                                <optgroup label="">
                                                    <option value="771">Gia sư tiếng Anh</option>
                                                    <option value="772">Gia sư tiếng Việt</option>
                                                    <option value="773">Gia sư tiếng Nhật</option>
                                                    <option value="774">Gia sư tiếng Hàn</option>
                                                    <option value="775">Gia sư tiếng Pháp</option>
                                                    <option value="776">Gia sư tiếng Nga</option>
                                                    <option value="777">Gia sư tiếng đức</option>
                                                    <option value="778">Gia sư tiếng ý</option>
                                                    <option value="779">Gia sư tiếng thái lan</option>
                                                    <option value="780">Gia sư tiếng Trung</option>
                                                    <option value="781">Gia sư toán học</option>
                                                    <option value="782">Gia sư vậy lý</option>
                                                    <option value="783">Gia sư hóa học</option>
                                                    <option value="784">Gia sư sinh học</option>
                                                    <option value="785">Gia sư luyện thi đại học</option>
                                                    <option value="786">Gia sư lập trình PHP</option>
                                                    <option value="787">Gia sư lập trình .Net</option>
                                                    <option value="788">Gia sư lập trình HTML & CSS</option>
                                                    <option value="789">Gia sư photoshop</option>
                                                    <option value="790">Gia sư android</option>
                                                    <option value="791">Gia sư Winphone</option>
                                                    <option value="792">Gia sư iOS</option>
                                                    <option value="793">Gia sư lập trình Python</option>
                                                    <option value="794">Gia sư lập trình Java</option>
                                                    <option value="795">Dạy nấu ăn</option>
                                                    <option value="796">Dạy đàn, nhạc</option>
                                                    <option value="835">Dịch vụ khác</option>
                                                    <option value="838">Gia sư đồ họa 3D</option>
                                                </optgroup>

                                            </select>
                                        </div>
                                        <div class="input-group-btn">
                                            <button class="btn btn-default btn  btn-raised ink-reaction btn-primary" type="submit">Đăng lớp</button>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="text-center mar-30-top btn-postjob-mobile">
                            <a class="btn btn-default btn  btn-raised ink-reaction btn-primary" href="dang-viec.html">Đăng lớp</a>
                        </div>
                        </span>
                </div>
                <div class="site-job-category row bg-white">
                    <div class="contain-lg">
                        <div class="slider-bottom">
                            <div class="btn-group btn-group-justified" role="group">

                                <a class="btn btn-default-bright" href="dang-viec/danh-muc/657-lap-trinh.html" role="button">
                                    <i class="fa fa-code"></i>
                                    Toán
                                </a>
                                <a class="btn btn-default-bright" href="dang-viec/danh-muc/770-day-kem.html" role="button">
                                    <i class="fa fa-graduation-cap"></i>
                                    Vật Lý
                                </a>
                                <a class="btn btn-default-bright" href="dang-viec/danh-muc/764-ke-toan.html" role="button">
                                    <i class="fa fa-calculator"></i>
                                    Hóa Học
                                </a>
                                <a class="btn btn-default-bright" href="dang-viec/danh-muc/761-luat.html" role="button">
                                    <i class="fa fa-legal"></i>
                                    Tiếng Anh
                                </a>
                                <a class="btn btn-default-bright" href="dang-viec/danh-muc/715-dich-thuat.html" role="button">
                                    <i class="fa fa-language"></i>
                                    Sinh Học
                                </a>
                                <a class="btn btn-default-bright" href="dang-viec/danh-muc/700-thiet-ke-kien-truc.html" role="button">
                                    <i class="fa fa-building-o"></i>
                                    Lịch Sử
                                </a>
                                <a class="btn btn-default-bright" href="dang-viec.html" role="button">
                                    <i class="fa fa-ellipsis-h"></i>&nbsp;&nbsp;Môn khác
                                </a>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="site-product bg-white">
                    <div class="block-title bg-white">Các gia sư nổi bật</div>
                    <div class="block-content bg-white">
                        <div class="contain-lg">
                            <div class="row list-products">
                                <div class="col-md-3">
                                    <div class="card product-item bg-none">
                                        <div class="card-body no-padding">
                                            <div class="product-img">
                                                <a href="goi-cong-viec/53-lam-ho-so-bhxh-cho-cong-ty-vua-va-nho.html"><img src="images/products/53/thumb_376x282_bao-hiem-xa-hoi_KuCG3SDg5n.png" alt="Làm hồ sơ BHXH cho công ty vừa và nhỏ"></a>
                                            </div>
                                            <div class="product-title">
                                                <h3><a href="goi-cong-viec/53-lam-ho-so-bhxh-cho-cong-ty-vua-va-nho.html">Nguyễn Văn A</a></h3>
                                            </div>
                                            <div class="product-info">
                                                ...
                                                150K/Buổi                                           </span>
                                                        <br />
                                                        <span class="product-time"><i class="fa fa-clock-o"></i> 14 Ngày</span>
                                                    </div>
                                                    <div class="col-sm-5">
                                                        <a class="btn btn-primary" href="goi-cong-viec/53-lam-ho-so-bhxh-cho-cong-ty-vua-va-nho.html">Xem Hồ Sơ</a>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                            ...
                            <p class="text-center  mar-30-top"><a href="danh-sach-goi-cong-viec.html" class="text-blue-hover text-lg">Xem tất cả <i class="fa fa-angle-double-right" aria-hidden="true"></i></a></p>
                        </div>
                    </div>
                </div>

                <div class="about-us site-testimonial">
                    <div class="block-title"><strong>Mọi Người</strong> nói về Gia Sư Smart</div>
                    <div class="about-us-content">
                        <div class="contain-lg">
                            <div class="flexslider carousel flexslider-testimonial">
                                <ul class="slides">
                                    <li>
                                        <div class="cnttestimonial col-md-12 col-sm-12 col-xs-12">
                                            <div class="site-testimonial-content">
                                                <div>
                                                    Tôi đã tìm được nhiều giasu trên giasusmart.com và thấy rất ok. Hiện tại tôi chỉ dùng duy nhất nơi này để tìm gia sư
                                                </div>
                                            </div>
                                            <div class="avatar active">
                                                    <span class=" img-avatar img-avatar-sm  bg  " style="background-image:url(../fvcontentsone.blob.core.windows.net/freelancerviettemplates/materials/images/testimonial/1.png)">
								</span>
                                                <div class="name"><strong>Hai Ho</strong>
                                                    <br /><small>CEO&Founder Triip.me</small></div>
                                            </div>
                                        </div>
                                    </li>
                ...
                <div class="show-off site-statistics">
                    <div class="show-off-top">
                        <div class="contain-lg">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="block-title ">Báo chí nói về Gia Sư Smart</div>
                                    <div class="block-content text-center">
                                        <a href="#" target="_blank" rel="noopener">
                                                <span class=" img-avatar bg " style="background-image:url(../fvcontentsone.blob.core.windows.net/freelancerviettemplates/materials/images/supporter/TiA.png)">
							</span>
                                        </a>
                                        <a href="#" target="_blank" rel="noopener">
                                                <span class=" img-avatar bg " style="background-image:url(../fvcontentsone.blob.core.windows.net/freelancerviettemplates/materials/images/supporter/tuoitreonline.png)">
							</span>
                                        </a>
                                        <a href="#" target="_blank" rel="noopener">
                                                <span class=" img-avatar bg " style="background-image:url(../fvcontentsone.blob.core.windows.net/freelancerviettemplates/materials/images/supporter/vnnews.png)">
							</span>
                                        </a>
                                        <a href="#" target="_blank" rel="noopener">
                                                <span class=" img-avatar bg " style="background-image:url(../fvcontentsone.blob.core.windows.net/freelancerviettemplates/materials/images/supporter/htv_9.png)">
							</span>
                                        </a>
                                        <a href="#" target="_blank" rel="noopener">
                                                <span class=" img-avatar bg " style="background-image:url(../fvcontentsone.blob.core.windows.net/freelancerviettemplates/materials/images/supporter/sctv4.png)">
							</span>
                                        </a>
                                        <a href="#" target="_blank" rel="noopener">
                                                <span class=" img-avatar bg " style="background-image:url(../fvcontentsone.blob.core.windows.net/freelancerviettemplates/materials/images/supporter/bizlive.png)">
							</span>
                                        </a>
                                        <a href="#" target="_blank" rel="noopener">
                                                <span class=" img-avatar bg  " style="background-image:url(../fvcontentsone.blob.core.windows.net/freelancerviettemplates/materials/images/supporter/vietfounder.png)">
							</span>
                                        </a>
                                    </div>
                                </div>
                    ...
                    <div class="show-off-text">Cần là có ngay gia sư
                        <br />Hãy thực hiện 1 trong 2 lựa chọn</div>
                    <div class="block-post-working">
                        <a href="dang-viec.html" class="btn  btn-raised ink-reaction btn-primary mar-cennter btn-inline ">Đăng lớp</a>
                        <a href="ho-so-freelancer.html" class="btn  btn-raised ink-reaction btn-default btn-transparent text-white mar-cennter btn-inline ">Tìm gia sư</a>
                    </div>
                </div>
                <!--end show-off-->
    ...
    <div class="contain-lg">
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="link clearfix">
                    <div class="col-md-4 col-sm-4 pad-reset">
                        <div class="head-tit">Gia Sư Smart</div>
                        <ul class="list-unstyled">
                            <li><a href="gioi-thieu.html">Nhà sáng lập và các chiến binh</a></li>
                            <li><a href="press.html">Vinh danh trên báo chí</a></li>
                            <li><a href="blog-ky-nang.html">Kỹ năng gia sư</a></li>
                            <li><a href="su-kien.html">Sự kiện cộng đồng gia sư</a></li>
                    ...
                    <div class="col-md-4 col-sm-4 pad-reset">
                        ...
                        <ul class="list-unstyled">
                            <li><a href="cach-tuyen-freelancer.html">Cách tuyển gia sư</a></li>
                            <li><a href="quy-dinh-dang-viec.html">Quy định đăng lớp</a></li>
                    ...
                    <div class="col-md-4 col-sm-4 pad-reset">
                        <div class="head-tit">Gia sư</div>
                        <ul class="list-unstyled">
                            <li><a href="cach-nhan-viec-lam-them.html">Cách nhận lớp</a></li>
            ...
            <div class="col-md-3">
                <div class="box-total ">
                    <div class="row">
                        <div class="text col-xs-8">Thời gian trung bình để tuyển được gia sư:</div>
                        <div class="number col-xs-4">24 giờ</div>
                    </div>
                </div>
                <div class="box-social">
                    <div class="text">Chúng tôi giải đáp 100% thắc mắc của bạn trong vòng 2 giờ
                        <br />Khi cần hỗ trợ hãy liên hệ</div>
                    <div class="row">
                        <div class="col-md-12 col-sm-6 col-xs-6">
                            <a class="text-white" rel="nofollow" href="mailto:support@giasusmart.com"><i class="fa fa-envelope-o"></i>&nbsp;&nbsp;support@giasusmart.com</a>
                            <br />
                            <a class="text-white" rel="nofollow" href="tel:+84 28 3932 6966"><i class="fa fa-phone"></i>&nbsp;&nbsp;+84 1694470593</a>
                        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-6 col-sm-6 pad-reset">
                <ul class="list-unstyled">
                    <li>
                        <br /> Chủ quản: Công ty CP Gia Sư Smart
                        <br /> VPGD: Dịch Vọng Hậu, Cầu Giấy, Hà Nội
                        <br /> Giấy phép ĐK KD Số: 0312548673 - Cấp ngày: 15/11/2013
                        <br /> Tại Sở Kế hoạch và Đầu tư Hà Nội </li>
                    <li>
            ...
            <div class="col-md-6 col-sm-6 pad-reset">
                <ul class="list-unstyled">
                    <li>
                        <br /> Đối tác: Công ty Cổ Phần Toi Yeu Bug
                        <br />
                        <a href="" target="_blank" rel="noopener"><i>Mua hàng trên Amazon</i></a>, <a href="" target="_blank" rel="noopener"><i>Hàng Mỹ xách tay</i></a>
                    </li>
                </ul>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                <div class="copy-right clearfix text-center" style="font-size:8pt">
                    <a href="index.htm"><img src="my-custom/logo-v2.png" alt="freelancerViet" /></a> <span class="text-2">- Tuyển ĐÚNG Gia Sư chỉ trong 24 Giờ</span>
                    <br />
                    <span class="text">&copy; 2017 GiaSuSmart. All Right Reserved.</span>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
    WebFontConfig = {
        google: {
            families: ['Open+Sans:400italic,300,400,600,700,800', 'Roboto:400,300,400italic,500,700&subset=latin,vietnamese,latin-ext']
        }
    };
    (function() {
...
<script>
    $(".btn-offcanvas-custom").offcanvas({
        cvcallback: function() {
